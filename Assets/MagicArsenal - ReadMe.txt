...
In this asset, two main folders are included: "InteractiveDemo" and "MagicArsenal".
...
The "MagicArsenal" folder contains the particle systems, textures and materials for all the effects.
To use them in your project, you will have to import this folder to your project folder.

The "KunaiEditor" folder is an extra, optional tool that lets you scale multiple particle effects at once.
...
Thanks to Julius Lyngby Forsberg for help with initial Magic Arsenal code.
